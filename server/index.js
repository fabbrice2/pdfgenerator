...
// const logoPath = 'chemin/vers/votre/logo.png'; 
  ...
  try {
    ...
    db.query(
      ...
      (selectErr, selectResults) => {
        ...
        doc.moveDown(2);
        doc.fontSize(20).text("Fabrice", { align: "start" });
        ...
        doc.moveDown(); 
        doc.fontSize(16).text("Coordonnées(s)", { underline: true });
        doc.fontSize(14).text(`Adresse postal: ${address}`);
        doc.fontSize(14).text(`Pays: ${country}`);
        doc.fontSize(14).text(`Zip: ${postalCode}`);
